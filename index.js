		  ...
		  if (err)
		   ...
		   { 
				...
				alertVar.forEach(function(value)
				{
					...
					randid_vote.substring(0, randid_vote.length - 1);
					votechoose_vote.substring(0, votechoose_vote.length - 1);
					votes_vote.substring(0, votes_vote.length - 1);
					uservoted_vote.substring(0, uservoted_vote.length - 1);
					ipvoted_vote.substring(0, ipvoted_vote.length - 1);
					title_vote.substring(0, title_vote.length - 1);
					votedalready.substring(0, votedalready.length - 1);			
